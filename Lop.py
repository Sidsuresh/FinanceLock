...
def open_login():
	...
	def forpass():
		auth.send_password_reset_email(e_user.get())
		messagebox.showinfo("Check", "Please check your email for the password reset link")
	...
	forpas_button = Button (top_lp, text = "Forget Password", command = forpass, background = "white", highlightbackground = "black", highlightthickness = 2)
